...
public class NetworkConstants {
    ...
    public static final String POI_URL = BASE_URL + REST + POI;
    public static final String PERSON_URL = BASE_URL + REST + PERSON;
    ...
    public static final String ROUTE_URL = BASE_URL + REST + ROUTE;
